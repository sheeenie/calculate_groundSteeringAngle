...
We will collaborate using Git, and more specifically, GitLab. We will create specific branches for features, called feature branches after the group creates and divides tasks/issues among us. We will conduct code reviews before pull/merge requests, and we will also be using the concept of pair-programming to some extent. We will not “ butt in “ on others’ work, even if you would do it faster. Furthermore, if a member is stuck on a specific task/problem, ask for help early to speed up the process as much as possible. 
...
To ensure knowledge transfer effectively, our group has created dedicated text and voice channels to heighten information sharing. Additionally, team members are encouraged to communicate any difficulties or uncertainties encountered during lectures or the work process, allowing others to share their experiences and insights. Regular knowledge-sharing sessions will also be scheduled, where members can discuss insights, experiences, and lessons related to their work through presentations, demos, or discussions.
...
Lastly, we will foster an open feedback culture where questions, ideas, and accountability are encouraged. Encouraging constructive feedback will help create an environment where team members feel comfortable asking questions, sharing their ideas, and admitting mistakes. Additionally, mentoring and cross-functional collaboration will be promoted, allowing experienced members to support others who might be struggling and enabling knowledge exchange across different areas of expertise. This approach will enhance knowledge sharing, keeping the team aligned on progress, potential blockers, and overall project development.
